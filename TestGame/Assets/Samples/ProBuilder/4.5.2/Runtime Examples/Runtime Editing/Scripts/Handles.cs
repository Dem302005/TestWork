...
namespace ProBuilder.Examples
{
    internal class Handles : MonoBehaviour
    {
        ...
        private static readonly Face[] s_FaceArray = new Face[1];
        ...
        private static void Init()
        {
            ...
            var lineShader = BuiltinMaterials.geometryShadersSupported
                ? s_Instance.m_LineBillboard
                : s_Instance.m_FaceHighlight;
            var vertShader = BuiltinMaterials.geometryShadersSupported
                ? s_Instance.m_PointBillboard
                : s_Instance.m_VertexShader;
        ...
        public static void Draw(ProBuilderMesh mesh, IEnumerable<Face> faces, Color color,
