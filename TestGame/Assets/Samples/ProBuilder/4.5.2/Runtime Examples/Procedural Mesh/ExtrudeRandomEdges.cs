...
namespace ProBuilder.Examples
{
	...
	internal class ExtrudeRandomEdges : MonoBehaviour
    {
        ...
        private Face m_LastExtrudedFace;
        ...
        private void ExtrudeEdge()
        {
            ...
            var wings = WingedEdge.GetWingedEdges(m_Mesh);
            var sourceWings = wings.Where(x => x.face == m_LastExtrudedFace);
            ...
            var dir = (edgeCenter - faceCenter).normalized;

            // this will be populated with the extruded edge
            Edge[] extrudedEdges;

            // perform extrusion
            extrudedEdges = m_Mesh.Extrude(new[] { sourceEdge }, 0f, false, true);
