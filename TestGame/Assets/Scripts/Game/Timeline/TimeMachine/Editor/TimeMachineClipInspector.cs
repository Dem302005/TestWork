...
public class TimeMachineClipInspector : Editor
{
    ...
    {
        var isMarker = false; //if it's a marker we don't need to draw any Condition or parameters
        ...
        var actionType = (TimeMachineBehaviour.TimeMachineAction)index;
        ...
        if (!isMarker)
        {
            ...
            var conditionType = (TimeMachineBehaviour.Condition)index;
