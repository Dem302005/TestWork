...
namespace Gamekit3D
{
    ...
    {
        private readonly AddObjectiveSubEditor addObjectiveSubEditor = new AddObjectiveSubEditor();

        private int showEvent = -1;
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUILayout.HorizontalScope("box"))
            {
                ...
                if (Application.isPlaying) EditorGUILayout.LabelField("Current", GUILayout.Width(64));
            ...
            using (var check = new EditorGUI.ChangeCheckScope())
            {
                for (var i = 0; i < property.arraySize; i++)
                {
                    ...
                    using (new EditorGUILayout.HorizontalScope("box"))
                    {
                        if (GUILayout.Button(o.FindPropertyRelative("name").stringValue)) showEvent = i;

                        if (Application.isPlaying)
                            EditorGUILayout.PropertyField(o.FindPropertyRelative("currentCount"), GUIContent.none,
                                GUILayout.Width(64));
                        EditorGUILayout.PropertyField(o.FindPropertyRelative("requiredCount"), GUIContent.none,
                            GUILayout.Width(64));
