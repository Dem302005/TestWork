...
Shader "Custom/ToonSkin"
{
    ...
    SubShader
    {
        ...
        float3 SubsurfaceShadingSimple(float3 diffColor, float3 normal, float3 viewDir, float3 thickness,
        ...
        half4 LightingSimpleSSS(SurfaceOutputStandardSpecular s, half3 viewDir, UnityGI gi)
        {
            ...
            c.rgb += SubsurfaceShadingSimple(_InternalColor, s.Normal, viewDir, s.Alpha * _SSS, gi.light.dir,
                   gi.light.color);
        ...
        void surf(Input IN, inout SurfaceOutputStandardSpecular o)
        {
            ...
            o.Albedo = c.rgb;
            o.Normal = BlendNormals(UnpackNormal(tex2D(_BumpMap, IN.uv_BumpMap)),
